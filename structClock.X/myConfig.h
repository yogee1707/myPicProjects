...
void serialComm()
{
    ...
    SPBRG1 = 25;        //baudrate 9.6k, 8bit, no parity for 4MHz clock
}
// eo serialComm9600::***************************************************************
...
Date:		10 April, 2019
Modified:	None
Desc:		Initializes timer 0
Input: 		None
Returns:	None
**********************************************************************************/
void timer0Config()
{
    T0CON = 0x93;         //10 01 01 01 //timer0 enable, pre-scalar 1:64, internal clock as source
    TMR0H = 0x0B;
    TMR0L = 0xDC;
